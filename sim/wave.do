...
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/BPDirPredF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/BPJumpF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/BPBranchF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/BPPCF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/BPPCSrcF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/PCPlus2or4F
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/PCSrcE
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/IEUAdrE
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/PC0NextF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/PCCorrectE
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/bpred/bpred/BPWrongE
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/PC1NextF
add wave -noupdate -expand -group {PCNext Generation} /testbench/dut/core/ifu/PC2NextF
...
WaveRestoreCursors {{Cursor 4} {3510 ns} 1} {{Cursor 4} {3501 ns} 0}
...
update
WaveRestoreZoom {3260 ns} {3742 ns}
